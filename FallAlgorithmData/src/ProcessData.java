...
public class ProcessData {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        for (int i = 1; i < 55; i++) {
            try {
                FileParser temp = new FileParser("/Users/vincentchow/Desktop/School/School 2021-2022/FallAlgorithmData/src/data/fall_" + i + "_clean.log");
                fallSize++;
                files.add(temp);
                expected.add(true);
            }
        ...
        for (int i = 2; i < 53; i++) {
            try {
                FileParser temp = new FileParser("/Users/vincentchow/Desktop/School/School 2021-2022/FallAlgorithmData/src/data/no_fall_"+i+"_clean.log");
                files.add(temp);
                expected.add(false);
            }
            catch (Exception exception){
